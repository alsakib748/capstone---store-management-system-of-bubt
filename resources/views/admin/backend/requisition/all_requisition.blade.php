                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-wrap gap-1">
                                                        <a title="Details" href="{{ route('details.requisition', $item->id) }}"
                                                            class="btn btn-info btn-sm"> <span
                                                                class="mdi mdi-eye-circle mdi-18px"></span> </a>

                                                        <a title="Invoice" href="{{ route('invoice.requisition', $item->id) }}"
                                                            class="btn btn-warning btn-sm" target="_blank"> <span
                                                                class="mdi mdi-file-pdf-box mdi-18px"></span> </a>

                                                        <a title="Edit" href="{{ route('edit.requisition', $item->id) }}"
                                                            class="btn btn-success btn-sm"> <span
                                                                class="mdi mdi-book-edit mdi-18px"></span> </a>

                                                        <a title="Delete" href="{{ route('delete.requisition', $item->id) }}"
