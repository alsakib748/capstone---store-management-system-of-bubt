 ...
 <div class="col-xl-12">
       ...
       <div class="row">
        ...
        <input type="hidden" name="to_warehouse_id" value="{{ $editData->to_warehouse_id }}">
          ...
          <div class="col-md-4 mb-3">
                ...
                <select name="from_warehouse_id" id="warehouse_id" class="form-control form-select select2" disabled>
    ...
    @endforeach
          ...
          <div class="col-md-4 mb-3">
            ...
            <select name="to_warehouse_id" id="warehouse_id" class="form-control form-select select2" disabled>
<option value="">Select Warehouse</option>
@foreach ($warehouses as $item)
