    ...
    <div class="card">
       <div class="row">
          ...
          <div class="col-md-4 mb-3">
                ...
                <select name="from_warehouse_id" id="warehouse_id" class="form-control form-select select2">
          ...
          <div class="col-md-4 mb-3">
            ...
            <select name="to_warehouse_id" id="warehouse_id" class="form-control form-select select2">
                  <option value="">Select Warehouse</option>
                  @foreach ($warehouses as $item)
                  <option value="{{ $item->id }}">{{ $item->name }}</option>
                  @endforeach
