...
class ProductController extends Controller
{
    ...
    {
        $allData = Product::with(['category', 'subcategory', 'images'])->orderBy('id', 'desc')->get();
    ...
    public function AddProduct()
    {
        ...
        return view('admin.backend.product.add_product', compact('categories', 'brands', 'suppliers', 'warehouses', 'subcategories'));
    }
    //End Method
    ...
    public function EditProduct($id)
    {
        ...
        return view('admin.backend.product.edit_product', compact('categories', 'brands', 'suppliers', 'warehouses', 'editData', 'multiimg', 'subcategories'));
    }
    //End Method
