...
class RoleController extends Controller
{
    ...
    public function AddAdmin()
    {
        ...
        return view('admin.backend.pages.admin.add_admin', compact('roles', 'departments'));
    }
    // End Method
    ...
    public function EditAdmin($id)
    {
        ...
        $roles = Role::all();
        $departments = Department::orderBy('name', 'asc')->get();
        return view('admin.backend.pages.admin.edit_admin', compact('admin', 'roles', 'departments'));
    }
    // End Method
